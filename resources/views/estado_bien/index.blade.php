...
@section('title', 'Estados del Bien')

@section('content_header')
    <h1>Gestión de Estados del Bien</h1>
@stop
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">
                    <i class="fas fa-plus-circle"></i> Nuevo Estado del Bien
                </h5>
            ...
            <form id="formCreate">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nombre_estado">Nombre del Estado <span class="text-danger">*</span></label>
                        <input type="text"
                               name="nombre_estado"
                               id="nombre_estado"
                               class="form-control"
                               maxlength="20"
                               required
                               placeholder="Ej: Operativo, En Mantenimiento, Baja..."
                               autocomplete="off">
                        <small class="form-text text-muted">Máximo 20 caracteres</small>
                        <span class="text-danger error-nombre_estado d-block mt-1"></span>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title">
                    <i class="fas fa-edit"></i> Editar Estado del Bien
                </h5>
                <button type="button" class="close text-white" data-dismiss="modal">
                    <span>&times;</span>
                </button>
            ...
            <form id="formEdit">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="edit_nombre_estado">Nombre del Estado <span class="text-danger">*</span></label>
                        <input type="text"
                               name="nombre_estado"
                               id="edit_nombre_estado"
                               class="form-control"
                               maxlength="20"
                               required
                               autocomplete="off">
                        <span class="text-danger error-edit-nombre_estado d-block mt-1"></span>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">
            ...
            error: function(xhr) {
                ...
                if(xhr.status === 422) {
                    ...
                    if(errors.nombre_estado) {
                        $('.error-nombre_estado').text(errors.nombre_estado[0]);
                    }
                } else {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if(xhr.status === 422) {
                    let errors = xhr.responseJSON.errors;
                    if(errors.nombre_estado) {
                        $('.error-edit-nombre_estado').text(errors.nombre_estado[0]);
                    }
                } else {
