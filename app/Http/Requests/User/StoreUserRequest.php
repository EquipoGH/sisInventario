...
class StoreUserRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $idResponsable = trim((string) $this->input('id_responsable', ''));
        ...
        $this->merge([
            ...
            'id_responsable' => $idResponsable === '' ? null : $idResponsable,
        ]);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'password_movil'   => ['nullable', 'confirmed', Password::min(6)], // 🔐 opcional al crear
            'dni_usuario'      => ['nullable', 'digits:8', Rule::unique('users', 'dni_usuario')],
            'rol_usuario'      => ['required', Rule::in(['ADMIN','INFORMATICA','INVITADO'])],
